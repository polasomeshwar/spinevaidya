        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-2">
              ...
              <a href="https://youtube.com/@spinevaidya?si=PnGSfUO4lyIsh3CE" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="w-10 h-10 rounded-full bg-white/5 border border-white/8 flex items-center justify-center text-white/50 hover:bg-gold hover:text-forest hover:border-gold transition-all duration-300">
                <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
